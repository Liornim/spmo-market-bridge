...
const data={
  NVDA:{rows:mkDay('2026-09-01',91,217,0.01), stale:40},
  AAPL:{rows:mkDay('2026-09-01',91,230,-0.02), stale:40},
  TSLA:{rows:mkDay('2026-09-01',91,340,0.0), stale:700},          // stale
  MSFT:{rows:[], stale:null},                                      // no data
  SPY:{rows:mkDay('2026-09-01',91,560,0.01), stale:40},
  QQQ:{rows:mkDay('2026-09-01',91,480,0.01), stale:40},
  SMH:{rows:mkDay('2026-09-01',91,260,0.01), stale:40},
  XLK:{rows:mkDay('2026-09-01',91,250,-0.01), stale:40},
};
let calls=[];
