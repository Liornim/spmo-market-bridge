...
// The QA report is generated by the batch runner. If it has not been run yet,
// serve a page that says so rather than a blank one.
let qaReport;
try { qaReport = readFileSync(new URL('./trader-v2-batch-report.html', import.meta.url), 'utf8'); }
catch (e) { qaReport = '<!doctype html><meta charset="utf-8"><body style="font:15px system-ui;padding:40px">'
  + 'דוח ה-QA טרם נוצר. הרץ <code>node trader-v2-batch-qa.cjs</code>.</body>'; }
...
writeFileSync(new URL('./view.js', import.meta.url),
  ...
  'export const TRADER_V2_RADAR_HTML = ' + JSON.stringify(traderV2Radar) + ';\n' +
