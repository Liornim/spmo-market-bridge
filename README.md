...
- `engine.cjs` — structure engine: K=3 swings, HH/HL/LH/LL, window levels, breakout/rejection/failure, structure break, trend change, scoring, ask flag. Pure function; `engine_test.cjs` covers it including a random-walk noise floor (~3 asks/day balanced)
