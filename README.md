...
- `radar.html` — Market Radar (separate page; does not touch `view.html`)
...
- `radar_smoke.mjs`, `copy_test.mjs` — run the radar page against a stub DOM: rendering, attention sort, freshness, and every candle-copy option
